...
const Header = () => {
  ...
  const currencyHandler = (e) => {
    ...
    //Select alanindaki degisim neticeisnde elde ediln degeri al
  ...
  return (
    <header className="flex items-center justify-between px-[10%] py-5 border-b-2 border-[#3c3c3c] bg-[#1a1a40]">
      ...
      <Link to="/">
        <img 
        src="/logo.png" 
        className="min-w-[90px] w-[12vw,120px]" 
        alt="logo" />
      </Link>
      {/* Nav */}
        ...
        <ul className="hidden md:flex gap-10 ml-[50px] lg:ml-0">
          <NavLink to="/"
          className="cursor-pointer hover:text-[#ffde4d] transition">Home </NavLink>

          <NavLink 
          className="cursor-pointer hover:text-[#ffde4d] transition"> Features </NavLink>

          <NavLink 
          className="cursor-pointer hover:text-[#ffde4d] transition">Pricing </NavLink>

          <NavLink 
          className="cursor-pointer hover:text-[#ffde4d] transition"> Blog </NavLink>
        </ul>
